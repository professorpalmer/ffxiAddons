...
local sets = {
    ...
    Idle = Equip.NewSet {
        ...
        Ring1 = "Rajas Ring",
        Ring2 = "Epona\'s Ring",
        Back = { Name = "Visucius\'s Mantle", Augment = { [1] = "Pet: R.Acc.+20", [2] = "Pet: R.Atk.+20", [3] = "Pet: Haste+10", [4] = "Accuracy+20", [5] = "Attack+20", [6] = "Pet: Acc.+20", [7] = "Pet: Atk.+20" } }, -- Pet-focused augments
    },
    ...
    Master = Equip.NewSet {
        ...
        Legs = "Heyoka Subligar +1",
        Feet = "Herculean Boots",
        Neck = "Asperity Necklace", -- Master acc/att focused
        Waist = "Moonbow Belt +1",
        Ear1 = "Mache Earring",
        Ear2 = "Mache Earring +1",
        Ring1 = "Rajas Ring",
        Ring2 = "Epona\'s Ring",
        Back = { Name = "Visucius\'s Mantle", Augment = { [1] = "DEX+30", [2] = "Accuracy+20", [3] = "Attack+20", [4] = "\"Double Attack\"+10%", [5] = "Damage taken-5%" } }, -- Master-focused augments
    },
    ...
    WeaponSkill = {
        ...
        ['Victory Smite'] = Equip.NewSet {
            Head = "Karagoz Capello +2",           -- DEX+
            Body = "Malignance Tabard",     -- STR+ crit hit rate
    ...
    Hybrid = Equip.NewSet {
        Main = "Xiucoatl",
        Range = "Animator P II +1",
        Head = "Heyoka Cap +1", -- Good DT and some offensive stats
        Body = "Malignance Tabard", -- Excellent DT with some offensive
        Hands = "Herculean Gloves", -- More offensive than Karagoz
        Legs = "Heyoka Subligar +1", -- DT with offensive stats
        Feet = "Herculean Boots", -- Offensive focused
        Neck = "Shulmanu Collar", -- Pet bonuses
        Waist = "Moonbow Belt +1", -- Accuracy/Attack
        Ear1 = "Sroda Earring",
        Ear2 = "Mache Earring +1",
        Ring1 = "Rajas Ring", -- Offensive
        Ring2 = "Gelatinous Ring +1", -- DT
        Back = { Name = "Visucius\'s Mantle", Augment = { [1] = "DEX+30", [2] = "Accuracy+20", [3] = "Attack+20", [4] = "\"Double Attack\"+10%", [5] = "Damage taken-5%" } }, -- Master-focused augments
    },
