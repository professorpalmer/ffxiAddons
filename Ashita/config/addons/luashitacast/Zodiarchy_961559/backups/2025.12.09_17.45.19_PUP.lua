...
profile.HandleDefault = function()
    ...
    -- overlay Treasure Hunter gear without dropping the base mode
    if (settings.THMode and sets.TH) then
        Equip.Set(sets.TH);
    end
    ...
    -- Ensure appropriate animator is equipped when Treasure Hunter mode is off
